                  ...
                  <div className="quick-actions">
                    <div className="action-item cursor-pointer" onClick={() => setActiveTab('carnes')}>
                      <div className="action-icon-box">
                        <i className="bi bi-qr-code-scan" style={{ color: 'var(--primary-red)' }}></i>
                      </div>
                      <div className="action-label">PIX</div>
                    </div>
                    <div className="action-item cursor-pointer" onClick={() => setActiveTab('carnes')}>
                      <div className="action-icon-box">
                        <i className="bi bi-upc-scan" style={{ color: 'var(--mm-card-blue)' }}></i>
                      </div>
                      <div className="action-label">BOLETO</div>
                    </div>
                    <div className="action-item cursor-pointer" onClick={() => setActiveTab('historico')}>
                      <div className="action-icon-box">
                        <i className="bi bi-wallet-fill" style={{ color: '#F59E0B' }}></i>
                      </div>
                      <div className="action-label">EXTRATO</div>
                    </div>
                    <div className="action-item cursor-pointer" onClick={() => setActiveTab('lojas')}>
                      <div className="action-icon-box">
                        <i className="bi bi-shop" style={{ color: '#10B981' }}></i>
                      </div>
